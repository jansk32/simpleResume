...
import gps from '../assets/portfolio/map.jpeg';
import mementos from '../assets/portfolio/timeline.jpeg';
                ...
                <div className="code-section center">
                    ...
                    <div className="code-slides">
                        <Carousel showArrows={true} centerMode={false} infiniteLoop={true}>
                              ...
                              <div className='slider my-slider justify-center content-center' key={index}>
